...
*
* Data Clock Edge Detector Instance (No Reset Version.)
*
* Version: 0.02
* Author : AUDIY
* Date   : 2026/03/10
...
module fireeee_dclk_edge_det_no_reset #(
    ...
    generate
        if (IN_REG_EN == 1'b1) begin: genblk_inreg1_noreset
            /* w/ Input Register */
            reg                          DCLKI_R = 1'b0;
        ...
        end else begin: genblk_inreg0_noreset
            /* w/o Input Register */
    ...
    generate
        if (OUT_REG_EN == 1'b1) begin: genblk_outreg1_noreset
            /* w/ Output Register */
        ...
        end else begin: genblk_outreg0_noreset
            /* w/o Output Register */
